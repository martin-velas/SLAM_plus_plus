...
int n_Run_SE3_Solver(const TCommandLineArgs &t_args) // throw(std::runtime_error, std::bad_alloc)
{
  ...
  typedef MakeTypelist_Safe((CEdgePose3D, CEdgePoseLandmark3D, CBSplineEdge, CEdge3DXYZ,
		  CEdge3DXYZOFF/*, CEdgePose3D_Ternary*/)) TEdgeTypelist_SE3; // testing hyperedges
